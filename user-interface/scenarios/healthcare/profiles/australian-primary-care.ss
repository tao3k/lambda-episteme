...
(export AustralianPrimaryCareProfile)

(.def (AustralianPrimaryCareProfile self HealthcareBaseProfile)
  (identity "lambda-episteme/ontology/healthcare/australia/primary-care")
  (name 'australian-primary-care)
  (.import
  ...
  (.add-concept
   (.o general-practice:
       ...
       (ontology-concept
        'MyMedicareRegistration '(Evidence) '(voluntary consent-required))
       clinical-referral:
  ...
  (.add-relation
   (.o registered-with:
       ...
       (ontology-relation
        ...
        'MyMedicareRegistration 'Patient '(consent-required))
       consent-for:
       (ontology-relation
        'CONSENT_FOR
        'HealthInformationConsent 'Patient '(purpose-limited))))
  (.add-source
   (.o australian-primary-care-authority:
       (ontology-source
        "healthcare/australia/primary-care/authority-evidence"
        "user-interface/scenarios/healthcare/sources/australian-primary-care-authority.json"
  ...
  (.add-threat
   (.o registration-without-dual-consent:
       (poo-flow-governance-threat
        ...
        (list
         (poo-flow-governance-precondition
          "healthcare/australia/primary-care/precondition/dual-consent"
          #t "evidence:mymedicare-dual-consent"))
       ...
       (poo-flow-governance-threat
        ...
        (list
         (poo-flow-governance-precondition
          "healthcare/australia/primary-care/precondition/provider-eligibility"
       ...
       (poo-flow-governance-threat
        ...
        (list
         (poo-flow-governance-precondition
          "healthcare/australia/primary-care/precondition/clinical-triage"
       ...
       (poo-flow-governance-threat
        ...
        (list
         (poo-flow-governance-precondition
          "healthcare/australia/primary-care/precondition/disclosure-consent"
  ...
  (.add-capability
   (.o schedule-primary-care:
       (poo-flow-authorization-capability
        "healthcare/australia/primary-care/capability/schedule-appointment"
        "HealthcareAU::Action::\"schedulePrimaryCareAppointment\""
        4301 'ordinary)))
  (.add-query (.o))
  (.assess-governance
   (lambda (context)
